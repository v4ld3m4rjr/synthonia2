...
// Descrição: Componente de entrada de data personalizado sem formatação automática
  ...
  return (
    <div className={`flex items-center space-x-2 ${className}`}>
      <input
        ...
        placeholder="DD"
        maxLength={2}
        className="w-16 px-2 py-2 text-center border border-gray-600 bg-gray-700 text-white rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        required={required}
      />
      ...
      <input
        ...
        placeholder="AAAA"
        maxLength={4}
        className="w-20 px-2 py-2 text-center border border-gray-600 bg-gray-700 text-white rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        required={required}
      />
